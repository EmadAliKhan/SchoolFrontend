    ...
    <>
      ...
      <div className="container-contact">
        <div className="contactUs mt-5">
          <h1 className="fw-bold text-primary">Contact <span className="fw-light text-danger">Us</span></h1>
        </div>
      </div>
      ...
      <div className="container mt-5 bg-light">
        <section className="row">
          <div className="col-12 col-sm-6">
            <h3 className="fw-bold text-center text-primary mt-2 fs-2">Send a Message</h3>
            <div className="inputBox">
              ...
              <div style={{ display: 'flex', flexDirection: "column" }}>
                <button className="btn btn-primary mt-3 py-2" onClick={ContactMessage}>Send message</button>
